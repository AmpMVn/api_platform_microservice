...
class LocationFulltextSearchFilter extends AbstractContextAwareFilter
{
    private $searchQuery;
    private $em;
    ...
    protected function filterProperty(string $property, $value, QueryBuilder $queryBuilder, QueryNameGeneratorInterface $queryNameGenerator, string $resourceClass, string $operationName = null, array $context = [])
    {
        ...
        $queryBuilder->andWhere('(LOWER('.$alias.'.name) LIKE :searchParam OR LOWER('.$alias.'.street) LIKE :searchParam OR LOWER('.$alias.'.zip) LIKE :searchParam OR LOWER('.$alias.'.city) LIKE :searchParam OR LOWER('.$alias.'.country) LIKE :searchParam)')
